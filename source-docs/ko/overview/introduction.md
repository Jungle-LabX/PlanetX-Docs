...
![우주에서 바라본 PlanetX 행성](overview-introduction-0.png)
...
처음 PlanetX를 사용하신다면 공식 첫 사용 경로인 [여기서 시작 — Same World 빠른 시작](?lang=ko&doc=quick-start-same-world)부터 진행하세요.
...
다음 단계에서는 [설치](?lang=ko&doc=installation)를 진행하거나, 바로 [여기서 시작 — Same World 빠른 시작](?lang=ko&doc=quick-start-same-world)을 따라 PlanetX를 사용해볼 수 있습니다.
